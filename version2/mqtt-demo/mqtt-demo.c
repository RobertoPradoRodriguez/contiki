...
static void ping_parent(void){
    //uip_ipaddr_t parent;
    //uip_ip6addr(&parent, 0xaaaa, 0, 0, 0, 0x0212, 0x7401, 0x0001, 0x0101);
    ...
    //uip_icmp6_send(&parent, ICMP6_ECHO_REQUEST,      0,       ECHO_REQ_PAYLOAD_LEN);
    //PRINT6ADDR(&parent);
}
